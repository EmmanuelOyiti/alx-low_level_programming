 ...
 * @e_ident: Is a pointer to array containing the ELF ABI version.
 */
void print_abi(unsigned char *e_ident)
{
 ...
 * @e_type: ELF type.
 * @e_ident: Is a pointer to array containing the ELF class.
 */
void print_type(unsigned int e_type, unsigned char *e_ident)
{
 ...
 *        ELF header right at the start of an ELF file.
